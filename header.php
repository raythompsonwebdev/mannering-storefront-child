...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div class="site-branding">
			...
			<div class="site-logo">
				<?php $mannering_woocommerce_child_site_title = get_bloginfo( 'name' ); ?>
					<a href=" <?php echo esc_url( home_url( '/' ) ); ?>" rel="home">
						<div class="screen-reader-text">
								<?php
									/* translators: %1$s:, CMSname: WordPress. */
									printf( esc_html_e( 'Go to the home page of %1$s', 'mannering-woocommerce-child' ), esc_html( $mannering_woocommerce_child_site_title ) );
								?>
						</div>
							<?php
							if ( has_custom_logo() ) :
						...
						<div class="site-firstletter" aria-hidden="true">
									<?php echo esc_html( substr( $mannering_woocommerce_child_site_title, 0, 1 ) ); ?>
						</div>
						<?php endif; ?>
				</a>
			</div>
	...
	<nav id="site-navigation" class="main-navigation">
			...
			<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'mannering-woocommerce-child' ); ?></button>
