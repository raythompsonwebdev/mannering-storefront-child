...
<div id="comments" class="comments-area">
	...
	if ( have_comments() ) :
	 ...
	 <h2 class="comments-title">
		...
		if ( '1' === $comment_count ) {
			...
			printf( // WPCS: XSS OK.
				...
				esc_html( _nx( '%1$s thought on &ldquo;%2$s&rdquo;', '%1$s thoughts on &ldquo;%2$s&rdquo;', $comment_count, 'comments title', 'mannering_music' ) ),
	 ...
	 <ol class="comment-list">
		...
		if ( ! comments_open() ) :
			?>
		 <p class="no-comments"><?php esc_html__( 'Comments are closed.', 'mannering_music' ); ?></p>
			<?php
		endif;
